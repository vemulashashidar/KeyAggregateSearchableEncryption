...
return false;
		...
		<div id="p-select" class="glidecontenttoggler">
            ...
            <a href="#" class="toc page_02">Register</a>
           <a href="login.jsp" class="toc page_03">Login</a>
            <a href="#" class="toc page_04">Portfolio</a>
            <a href="#" class="toc page_05">Contact</a>
          ...
          <td width="328">
              ...
              <tr> 
                <td height="34"><font color="#66FFFF" size="4"><strong>Email</strong></font></td>
                          ...
                          <tr> 
						   <tr> 
                            <td><font color="#66FFFF" size="4"><strong>Type Of User</strong></font></td>
                            <td>  <select  name="type" style="red" value="-1" >
					        <option style="color:red" value="">--Select User Type--</option>
           					 <option style="color:red" value="DataOwner">Data Owner</option>
          					  <option style="color:red" value=" DataUser">Data User</option>
         				  </select></td>
                          </tr>
                          <tr> 
