	...
	<div id="templatemo_top_panel">
		...
		<div id="p-select" class="glidecontenttoggler">
           ...
           <a href="keyshare.jsp" class="toc page_03">Key Share</a>
            <a href="#" class="toc page_04">View Share File</a>
	  ...
	  <p>&nbsp;</p>
          ...
          <tr> 
            ...
            <td width="100" height="33"><font color="#CC0000" size="3"><strong>File 
              Name</strong></font></td>
			   <td width="67" height="33"><font color="#CC0000" size="3"><strong>Key1 
              </strong></font></td>
		  ...
		  //String sat="send cloud";
             		   ...
             		   try
		   {
			  ...
			  String key2=rs5.getString("akey3");
					 String owner=rs5.getString("fowner");
					 %>
          <tr> 
		  <td height="59"><font color="#FFFFFF" size="+1"> 
            ...
            <td height="59"><font color="#FFFFFF" size="+1"> 
              ...
              <%=key2%>
			       ...
			       <td><a href="share.jsp"><img src="../images/share-button.png" width="142" height="55" /></a></td>
          <%
	   					}
		   }
		   catch(Exception e)
