    ...
    <p>&nbsp;</p>
	  <p>&nbsp;</p>
          ...
          <tr> 
            ...
            <td width="203"><font color="#CC0000"><strong><font size="3">Download File</font></strong></font></td>
            </tr>
          <%   
		  String wat="keysend";
		  //String sat="send cloud";
             		   ...
             		   try
		   {
				...
				ResultSet rs5 =st5.executeQuery("SELECT * FROM up where status='"+wat+"'&&fowner='"+uname+"'");
				while(rs5.next())
				{
