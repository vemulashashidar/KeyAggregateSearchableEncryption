...
<div id="templatemo_container">
  ...
  <p>&nbsp;</p>
   <p>&nbsp;</p>
                   ...
                   <center><span class="style9"> <font color="#66FFFF" size="5"><strong>User Login</strong></font> 
                      </span></center>
            <center>
			    <p>&nbsp;</p>
				 <p>&nbsp;</p>
	  ...
	  <tr>
	    	...
	    	<td>
                 ...
                 <span class="style9"> <font color="#66FFFF" size="5"><strong>  Name:</strong></font> 
                      </span> </td><td>
      <input name="name" id="name" value="" type="text"  /></td></tr><tr>
        ...
        <tr><td></td><td>
		  ...
		  <tr><td></td><td>
		     <p>&nbsp;</p>
			    <p>&nbsp;</p>
              <a href="register.jsp"><img src="images/Register-Now-Button-1000x288.png" width="233" height="41" /> </a>
            </td></tr></table> </form>
   ...
   <%                   String faild="faild";
        			...
        			if(dd==null){
        				...
        				<center><font size="5" color="red">Success </font></center><%
        				
        			}
        			else if(dd.equals(faild)){%> 
        				 <center><font size="5" color="red"> <marquee   scrolldelay="1">Username Password Wrong</marquee>
   </font></center><%
        			}
        		%>
    <p>&nbsp;</p>
