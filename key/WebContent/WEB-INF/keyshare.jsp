    ...
    <p>&nbsp;</p>
	 <%
        			...
        			if(dd==null){
        				...
        				<center><font size="5" color="red">File Succesfly  Shared </font></center>
        				<%
        			}
        			else{
        				out.println("FIle share faild");
        			}
        		%>
	  <p>&nbsp;</p>
	       <table   width="75%" height="111"   border="2">
          <tr> 
		    <td width="47" height="33"><font color="#CC0000" size="3"><strong>Total 
              files</strong> </font></td>
            <td width="100" height="33"><font color="#CC0000" size="3"><strong>File 
              Name</strong></font></td>
			   <td width="67" height="33"><font color="#CC0000" size="3"><strong>User 
              Key</strong></font></td>
			   <td width="73" height="33"><font color="#CC0000" size="3"><strong>User Name 
              </strong></font></td>
            
            <td width="74"><font color="#CC0000"><strong><font size="3">Status</font></strong></font></td>
		  ...
		  String sat1="waiting";
             		   ...
             		   try
		   {
   			...
   			//Connection con5=databasecon.getconnection(); 
				...
				ResultSet rs5 =st5.executeQuery("SELECT * FROM up where share='"+sat1+"'&& status='"+wat+"'&&fowner='"+uname+"'");
				while(rs5.next())
				{
		  ...
		  <td height="59"><font color="#FFFFFF" size="+1"> 
            ...
            <td><font color="#FFFFFF" size="+1"> 
              <%=rs5.getString("status")%>
			       ...
			       <td><a href="shareupdate.jsp?id=<%=iid%>"><img src="images/share-button.png" width="142" height="55" /></a></td>
          <%
	   					}
		   }
		   catch(Exception e)
